function Button({ variant = 'secondary', className = '', children, ...props }) {
  const base =
    'inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-lg px-3.5 py-2.5 text-sm font-semibold shadow-xs disabled:cursor-not-allowed disabled:opacity-50'
  const variants = {
